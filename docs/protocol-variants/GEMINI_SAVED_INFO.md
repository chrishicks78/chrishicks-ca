# Gemini Saved Info Cards

Gemini uses "Saved info" cards with approximately 1500 characters per card. Use two cards for the complete protocol.
...
1. Open Gemini → Settings (gear icon)
2. Click "Saved info" or "Memory"
3. Click "+ Add" to create a new card
4. Title the first card "Profile" and paste Card A content
5. Click "+ Add" again for a second card
6. Title it "Protocol Rules" and paste Card B content
7. Save both cards

## Notes

- Gemini has been observed to support ~10 active Saved Info cards
- Keep the most important cards first
- The character limit appears to be around 1500 per card based on user testing
- If you hit a limit, remove the first sentence "Applies to every prompt..." from Card B
