...
- Added navigation bar (Story, Mission, Take Action, Contact)
...
### 3. Depanneur OS — Untouched (Intentionally)

The Depanneur OS was rewritten as a Next.js app in recent commits (boot splash,
chiptune OST, compliance tracking, i18n, etc.). It has its own README and active
development track — no changes were applied to avoid clobbering that work.
